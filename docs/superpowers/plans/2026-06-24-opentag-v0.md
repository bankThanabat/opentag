...
- Risk: Task 8's Probot app has a placeholder run creation path until wired to the dispatcher HTTP API. The testable handler boundary is intentional so the next slice can connect it cleanly.
